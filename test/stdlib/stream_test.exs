defmodule StreamData.StreamTest do
  use ExUnit.Case, async: true
  use ExUnitProperties
  alias Sandbox.Stream

  # TODO: Make this unconditional when we depend on Elixir 1.13+.
  # if function_exported?(Stream, :slide, 3) do
  if true do
    describe "Stream.slide/3" do
      ...
      #     }
      #
      #     assert Stream.slide(list, negative_range, insertion_idx) ==
      #              Stream.slide(list, range, insertion_idx)
      #   end
      # end
      ...
      property "matches behavior for lists, ranges, and sets" do
        ...
        check all({slide_range, insertion_idx} <- slide_spec(list)) do
          ...
          slide = &Stream.slide(&1, slide_range, insertion_idx)
